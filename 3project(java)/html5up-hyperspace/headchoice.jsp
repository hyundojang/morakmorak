				...
				<!-- Main -->
					<section id="main" class="wrapper">
						...
						<div class="inner">
							...
							<div class="content">
									<a onfocus="blur()" href="" onMouseOver="this.innerHTML='정수리탈모'" onMouseOut="this.innerHTML='정수리를<br>중심으로 '">정수리를 <br>중심으로 </a>
								</div>
						<div class="img-cover"></div>
							...
							<div class="content">
									<a onfocus="blur()" href="" onMouseOver="this.innerHTML='원형탈모'" onMouseOut="this.innerHTML='부분적으로<br>동그랗게 '">부분적으로 <br> 동그랗게 </a>
								</div>
						<div class="img-cover"></div>
							</div>
							<div class="loss_m">
							<div class="content">
									<a onfocus="blur()" href="" onMouseOver="this.innerHTML='M자탈모'" onMouseOut="this.innerHTML='헤어라인이<br>M모양으로 '">헤어라인이 <br>M모양으로 </a>
								</div>
						<div class="img-cover"></div>
							</div> 
						</div>
