...
<head>
   ...
   <body class="is-preload" >
      ...
      <!-- Header -->
         <header id="header">
            <a href="index.html" class="title">모락모락</a>
            <nav>
               <ul>
      ...
      <div class="row">
        <div class="col-4" align="center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <input type="hidden" class="please" id="pro_url10" value="https://search.shopping.naver.com/search/all?query=%EB%8B%AC%EB%A6%AC%ED%94%84%20%ED%97%A4%EC%96%B4%ED%86%A0%EB%8B%89&frm=NVSHATC&prevQuery=%EB%8B%A5%ED%84%B0%20%EB%B0%A9%EA%B8%B0%EC%9B%90%20%ED%97%A4%EC%96%B4%ED%8A%B8%EB%A6%AC%ED%8A%B8%EB%A8%BC%ED%8A%B8">
              ...
              <img class="heart1" src="images/CART-removebg-preview.png" onclick="ajaxCall(10)" width="50px" height="50px" style="float:right; margin-right: 20%;">
            </div>
          </div>
        </div>
        <div class="col-4" align="center">
          ...
          <div class="card">
            ...
            <div class="card-body">
              <input type="hidden" class="please" id="pro_url11" value="https://search.shopping.naver.com/search/all?query=%EB%8B%A4%EC%8A%88%20%ED%97%A4%EC%96%B4%ED%86%A0%EB%8B%89&frm=NVSHATC&prevQuery=%EB%8B%AC%EB%A6%AC%ED%94%84%20%ED%97%A4%EC%96%B4%ED%86%A0%EB%8B%89">
              ...
              <!-- <a class = "heart" href="#"><img src="images/CART-removebg-preview.png" width="50px" height="50px"></a> -->
              <img class="heart1" src="images/CART-removebg-preview.png" onclick="ajaxCall(11)" width="50px" height="50px" style="float:right; margin-right: 20%;">
            </div>
          </div>
        </div>
        <div class="col-4" align="center">
          ...
          <img src="images/DR_Bang_Tonic-removebg-preview.png" height="500px">
            <div class="card-body">
              <input type="hidden" class="please" id="pro_url12" value="https://search.shopping.naver.com/search/all?query=%EB%8B%A5%ED%84%B0%20%EB%B0%A9%EA%B8%B0%EC%9B%90%20%ED%97%A4%EC%96%B4%ED%86%A0%EB%8B%89&frm=NVSHATC&prevQuery=%EB%8B%A4%EC%8A%88%20%ED%97%A4%EC%96%B4%ED%86%A0%EB%8B%89">
              ...
              <!-- <a class = "heart" href="#"><img src="images/CART-removebg-preview.png" width="50px" height="50px"></a> -->
              <img class="heart1" src="images/CART-removebg-preview.png" onclick="ajaxCall(12)" width="50px" height="50px" style="float:right; margin-right: 20%;">
            </div>
          </div>
        </div>
        <div class="col-4" align="center">
          ...
          <img src="images/DR_Bang_treatment-removebg-preview.png" height="500px">
            <div class="card-body">           
              <input type="hidden" class="please" id="pro_url13" value="https://search.shopping.naver.com/search/all?query=%EB%8B%A5%ED%84%B0%20%EB%B0%A9%EA%B8%B0%EC%9B%90%20%ED%97%A4%EC%96%B4%ED%8A%B8%EB%A6%AC%ED%8A%B8%EB%A8%BC%ED%8A%B8&frm=NVSHATC&prevQuery=%EB%8B%A5%ED%84%B0%20%EB%B0%A9%EA%B8%B0%EC%9B%90%20%ED%97%A4%EC%96%B4%ED%86%A0%EB%8B%89">
              ...
              <!-- <a class = "heart" href="#"><img src="images/CART-removebg-preview.png" width="50px" height="50px"></a> -->
              <img class="heart1" src="images/CART-removebg-preview.png" onclick="ajaxCall(13)" width="50px" height="50px" style="float:right; margin-right: 20%;">
            </div>
          </div>
        </div>
        <div class="col-4" align="center">
          ...
          <img src="images/head_spa_treatment-removebg-preview.png">
            <div class="card-body">           
              <input type="hidden" class="please" id="pro_url14" value="https://search.shopping.naver.com/search/all?query=%ED%97%A4%EB%93%9C%EC%8A%A4%ED%8C%8C%20%ED%97%A4%EC%96%B4%ED%8A%B8%EB%A6%AC%ED%8A%B8%EB%A8%BC%ED%8A%B8%20%EB%8D%94%20%ED%94%84%EB%A6%AC%EB%AF%B8%EC%97%84&frm=NVSHATC&prevQuery=%EB%8B%A5%ED%84%B0%20%EB%B0%A9%EA%B8%B0%EC%9B%90%20%ED%97%A4%EC%96%B4%ED%8A%B8%EB%A6%AC%ED%8A%B8%EB%A8%BC%ED%8A%B8">
              ...
              <!-- <a class = "heart" href="#"><img src="images/CART-removebg-preview.png" width="50px" height="50px"></a> -->
              <img class="heart1" src="images/CART-removebg-preview.png" onclick="ajaxCall(14)" width="50px" height="50px" style="float:right; margin-right: 20%;">
            </div>
          </div>
        </div>
        <div class="col-4" align="center">
          ...
          <img src="images/Ryo_treatment-removebg-preview.png">
            <div class="card-body">           
              <input type="hidden" class="please" id="pro_url15" value="https://search.shopping.naver.com/search/all?query=%EB%A0%A4%20%ED%97%A4%EC%96%B4%ED%8A%B8%EB%A6%AC%ED%8A%B8%EB%A8%BC%ED%8A%B8&frm=NVSHATC&prevQuery=%ED%97%A4%EB%93%9C%EC%8A%A4%ED%8C%8C%20%ED%97%A4%EC%96%B4%ED%8A%B8%EB%A6%AC%ED%8A%B8%EB%A8%BC%ED%8A%B8%20%EB%8D%94%20%ED%94%84%EB%A6%AC%EB%AF%B8%EC%97%84">
              ...
              <!-- <a class = "heart" href="#"><img src="images/CART-removebg-preview.png" width="50px" height="50px"></a> -->
              <img class="heart1" src="images/CART-removebg-preview.png" onclick="ajaxCall(15)" width="50px" height="50px" style="float:right; margin-right: 20%;">
            </div>
          </div>
        </div>               
      </div>
         ...
         <script src="assets/js/main.js"></script>
          ...
          function ajaxCall(num) {
            ...
            $.ajax({
               type :"get" ,
               url : "InterestService",
               data : {"pro_name" : pro_name, "pro_url" : pro_url},
               dataType : "text",
