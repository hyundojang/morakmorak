  ...
  <div class="container">
      <div class="row">
        ...
        <div class="col-4" align="center">
          ...
          <div class="card">
            ...
            <input type="hidden" class="please" id="pro_name17" value="다슈 흑채">
              ...
              <a href="https://search.shopping.naver.com/search/all?query=다슈 흑채" class="btn btn-primary" style="float:left; margin-left: 20%;"><img src="images/money-removebg-preview.png" width="50px" height="50px"></a>
              <!-- <a class = "heart" href="#"><img src="images/CART-removebg-preview.png" width="50px" height="50px"></a> -->
        ...
        <div class="col-4" align="center">
          ...
          <img src="images/furad_heakchae-removebg-preview.png" width="400px">
            ...
            <input type="hidden" class="please" id="pro_name18" value="퓨레드 흑채">       
              ...
              <a href="https://search.shopping.naver.com/search/all?query=퓨레드 흑채" style="float:left; margin-left: 20%;"><img src="images/money-removebg-preview.png" width="50px" height="50px"></a>
              <!-- <a class = "heart" href="#"><img src="images/CART-removebg-preview.png" width="50px" height="50px"></a> -->
        ...
        <div class="col-4" align="center">
          ...
          <img src="images/Aheads_brush-removebg-preview.png">
            ...
            <input type="hidden" class="please" id="pro_name20" value="어해즈 헤어브러쉬">
              ...
              <p class="card-text">#굳어진 피지제거 #방수기능 #인체공학적 디자인</p>
        ...
        <div class="col-4" align="center">
          <p align="left">NO.6</p>
          <div class="card">
          <img src="images/preal_head-removebg-preview.png" width="400px">
            <div class="card-body">           
            ...
            <input type="hidden" class="please" id="pro_name21" value="LG프라엘 메디헤어">
              ...
              <p class="card-text">#탈모치료 광기술 #편리한 마이케어 모드 #입증된 치료효과</p>
